...
The aim of this repo is to provide a minimal emacs configuration that restricts the use external packages trying to leverage emacs built-in functionality.
